...
/// ```
/// Pass the asset to [WKAssetGiffyDialog] via [image] prop using Flutter's `Image.asset(name)` widget.
/// ```
/// AssetGiffyDialog(
///   title: Text('Example'),
...
///   ...,
/// );
class WKAssetGiffyDialog extends StatefulWidget {
  WKAssetGiffyDialog({
    Key key,
    @required this.image,
    @required this.title,
    ...
    this.onNeverAskMeAgainCheckboxPressed,
    this.checkboxValue,
    this.description,
  ...
  final ValueChanged<bool> onNeverAskMeAgainCheckboxPressed;
  ...
  @override
  _WKAssetGiffyDialogState createState() => _WKAssetGiffyDialogState();
}

class _WKAssetGiffyDialogState extends State<WKAssetGiffyDialog> {
  @override
  Widget build(BuildContext context) {
    return BaseGiffyDialog(
      ...
      onlyOkButton: widget.onlyOkButton,
      onlyCancelButton: widget.onlyCancelButton,
      buttonCancelColor: widget.buttonCancelColor,
      buttonRadius: widget.buttonRadius,
      buttonCancelText: widget.buttonCancelText,
      buttonOkColor: widget.buttonOkColor,
      onOkButtonPressed: widget.onOkButtonPressed,
      onCancelButtonPressed: widget.onCancelButtonPressed,
      checkboxWidget: widget.checkboxWidget,
      buttonOkText: widget.buttonOkText,
