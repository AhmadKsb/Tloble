...
class _MyHomePageState extends State<MyHomePage>
  ...
  Future<void> _loadShein() async {
    ...
    try {
      ...
      imageLink = screen.body.split("\$img.src = \"")[1].split("\"")[0];

      imageLink = imageLink.toString().contains("https://") ||
              imageLink.toString().contains("http://")
          ? imageLink.toString().replaceAll("//", "")
          : "https://" + imageLink.toString().replaceAll("//", "");

      print("AAAA $imageLink");
  ...
  Future<void> _getProductImage() async {
    ...
    } else if (productImageLink.contains("shein")) {
      await _loadShein();
