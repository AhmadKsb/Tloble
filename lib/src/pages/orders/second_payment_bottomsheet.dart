...
class SecondPaymentBottomsheet extends StatefulWidget {
  ...
  @override
  State<StatefulWidget> createState() => _SecondPaymentBottomsheetState();
}

class _SecondPaymentBottomsheetState extends State<SecondPaymentBottomsheet> {
  bool _isLoading = false;
  String? secondPayment;

  FocusNode secondPaymentNode = new FocusNode();
  ...
  Widget build(BuildContext context) {
    return Container(
      ...
      child: Column(
        ...
        children: <Widget>[
          Text(
            Localization.of(context, 'second_payment'),
            textAlign: TextAlign.start,
            style: TextStyle(fontWeight: FontWeight.bold),
          ),
          SizedBox(height: 20),
          Text(
            Localization.of(context, 'enter_the_second_payment_received'),
            textAlign: TextAlign.start,
          ),
          SizedBox(height: 9),
          _buildSecondPayment(),
  ...
  Widget _buildSubmitBtn() {
    return Padding(
      ...
      child: RaisedButtonV2(
        ...
        disabled: _isLoading || (secondPayment?.isEmpty ?? true),
  ...
  void _onSubmit() async {
    ...
    try {
      await _updateFinalPaymentOrder();
  ...
  Future<void> _updateFinalPaymentOrder() async {
    try {
      setState(() {
        _isLoading = true;
      });
